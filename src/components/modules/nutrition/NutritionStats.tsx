  ...
  return (
    <GlassCard style={{ padding: '24px' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', width: '100%', marginBottom: '16px', paddingBottom: '16px', borderBottom: '1px solid rgba(193,96,58,0.15)' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.14em', color: '#b08878', marginTop: '4px' }}>
              Nutricion diaria
            </p>
          </div>
        </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '100%' }}>
        <h3 style={{ fontSize: '34px', lineHeight: 1, fontFamily: '"Outfit", sans-serif', fontWeight: 600, color: '#2d1a0e' }}>
          Desglose Macros
        </h3>
        <ProgressBar
          label="Proteína"
      ...
      <div style={{ marginTop: '32px', paddingTop: '24px', borderTop: '1px solid rgba(193,96,58,0.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
        <span style={{ fontSize: '14px', fontWeight: 600, color: '#7a4a36' }}>
          Cumplimiento Semanal
        </span>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span style={{ fontSize: '20px', fontWeight: 700, fontFamily: '"Outfit", sans-serif', color: '#c1603a' }}>{compliance}%</span>
